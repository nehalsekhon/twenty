...
const OPPORTUNITY_TEMPLATES = [
  { name: 'Enterprise iPad Deployment', amount: 2500000, stage: 'QUOTATION' },
  { name: 'MacBook Pro Fleet Upgrade', amount: 1800000, stage: 'CONSULTATION' },
  { name: 'iPhone Corporate Program', amount: 3200000, stage: 'INQUIRY' },
  {
    name: 'Apple TV+ Enterprise License',
    amount: 450000,
    stage: 'MEASUREMENTS',
  },
  { name: 'Mac Studio Creative Suite', amount: 890000, stage: 'QUOTATION' },
  { name: 'iPad Pro Design Team Setup', amount: 670000, stage: 'CONSULTATION' },
  { name: 'Apple Watch Corporate Wellness', amount: 320000, stage: 'INQUIRY' },
  {
    name: 'iMac Office Workstation Refresh',
    amount: 1200000,
    stage: 'INSTALLATION',
  },
  { name: 'Apple One Business Bundle', amount: 180000, stage: 'QUOTATION' },
  {
    name: 'MacBook Air Remote Work Package',
    amount: 950000,
    stage: 'CONSULTATION',
  },
  { name: 'Apple Pencil Educational License', amount: 85000, stage: 'INQUIRY' },
  {
    name: 'Mac Pro Video Production Setup',
    amount: 2100000,
    stage: 'MEASUREMENTS',
  },
  { name: 'iPhone SE Frontline Workers', amount: 780000, stage: 'QUOTATION' },
  { name: 'Apple CarPlay Integration', amount: 1500000, stage: 'CONSULTATION' },
  { name: 'iPad Air Retail Deployment', amount: 620000, stage: 'INQUIRY' },
  {
  ...
  { name: 'iPad Mini Field Operations', amount: 380000, stage: 'QUOTATION' },
  {
  ...
  { name: 'iPhone Photography Workshop', amount: 65000, stage: 'INQUIRY' },
  {
  ...
  { name: 'iPad Pro AR Development Kit', amount: 490000, stage: 'QUOTATION' },
  {
  ...
  { name: 'iPhone Security Audit Services', amount: 195000, stage: 'INQUIRY' },
  {
  ...
  { name: 'iPhone App Development Workshop', amount: 95000, stage: 'INQUIRY' },
  {
