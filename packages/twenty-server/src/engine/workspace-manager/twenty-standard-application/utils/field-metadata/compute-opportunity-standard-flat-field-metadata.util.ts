...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  stage: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        {
          id: 'e8aef789-0cff-4301-8738-612451952164',
          value: 'INQUIRY',
          label: i18nLabel(msg`Inquiry`),
          position: 0,
          color: 'gray',
        },
        {
          id: 'd83a2c80-8439-48b2-9599-d936180d2711',
          value: 'CONSULTATION',
          label: i18nLabel(msg`Consultation`),
          position: 1,
          color: 'sky',
        },
        {
          id: 'ddfd4c78-1e62-4b6a-801c-8f8ccd0247f3',
          value: 'MEASUREMENTS',
          label: i18nLabel(msg`Measurements`),
          position: 2,
          color: 'purple',
        },
        {
          id: '051d71d1-be68-4201-a84c-656369010ebb',
          value: 'QUOTATION',
          label: i18nLabel(msg`Quotation`),
          position: 3,
          color: 'orange',
        },
        {
          id: '9c806169-c2ad-44bc-b214-fd4438831ea5',
          value: 'ORDER_CONFIRMED',
          label: i18nLabel(msg`Order Confirmed`),
          position: 4,
          color: 'yellow',
        },
        {
          id: '8c3f581f-dfa6-47d0-a2b2-3c3d4e08717d',
          value: 'IN_PRODUCTION',
          label: i18nLabel(msg`In Production`),
          position: 5,
          color: 'turquoise',
        },
        {
          id: '854d2646-3cfa-4f2a-8354-e39408dc80c5',
          value: 'ORDER_READY',
          label: i18nLabel(msg`Order Ready`),
          position: 6,
          color: 'blue',
        },
        {
          id: '450b19dc-f7d3-4b33-b443-06cfc6907bd1',
          value: 'INSTALLATION',
          label: i18nLabel(msg`Installation`),
          position: 7,
          color: 'green',
        },
      ],
